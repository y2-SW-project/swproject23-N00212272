            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="fName" class="col-md-4 col-form-label text-md-end">{{ __('fName') }}</label>
                         ...
                         <div class="row mb-3">
                            <label for="lName" class="col-md-4 col-form-label text-md-end">{{ __('lName') }}</label>
                        ...
                        <div class="row mb-3">
                         ...
                         <div class="row mb-3">
                            <label for="address3" class="col-md-4 col-form-label text-md-end">{{ __('address3') }}</label>
